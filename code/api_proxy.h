...
static __nocfi struct perf_event* x_register_user_hw_breakpoint(struct perf_event_attr *attr, perf_overflow_handler_t triggered, void *context, struct task_struct *tsk) {
	return register_user_hw_breakpoint_sym(attr, triggered, context, tsk);
}

static __nocfi void x_unregister_hw_breakpoint(struct perf_event *bp) {
	unregister_hw_breakpoint_sym(bp);
}

static __nocfi int x_modify_user_hw_breakpoint(struct perf_event *bp, struct perf_event_attr *attr) {
