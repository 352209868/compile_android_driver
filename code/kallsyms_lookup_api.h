...
static struct perf_event* (* __nocfi register_user_hw_breakpoint_sym)(struct perf_event_attr *attr, perf_overflow_handler_t triggered, void *context, struct task_struct *tsk);
static void (* __nocfi unregister_hw_breakpoint_sym)(struct perf_event *bp);
#ifdef CONFIG_MODIFY_HIT_NEXT_MODE
static int (* __nocfi modify_user_hw_breakpoint_sym)(struct perf_event *bp, struct perf_event_attr *attr);
#endif
